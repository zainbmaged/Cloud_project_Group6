...
PREP_CFG = {
    "min_question_len":   40,
    "min_answer_len":     100,    # matches notebook actual run (argparse default=100, not CONFIG default=1000)
...
def _plot_latex(ax, df):
    ...
    ax.set_xlabel("LaTeX expression count per Q+A pair", fontsize=9)
